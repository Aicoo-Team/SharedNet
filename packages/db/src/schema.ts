...
export const messages = sharednetSchema.table(
  ...
  (table) => [
    ...
    check(
      ...
      // subquery, and an Instance id can never contain the separator. The
      // bound is MAX_ADMISSIONS: naming Instances to address is the same
      // question as naming them to seat.
